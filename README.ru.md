...
<p align="center">
  <img src="docs/screenshot.png" alt="Вкладка генерации" width="330">
  <img src="docs/screenshot-email.png" alt="Вкладка проверки почты" width="330">
</p>
...
- **Пакетный экспорт** — до 200 паролей за раз со скачиванием в `.txt` или `.md` (полностью локально — лимиты API не тратятся).
